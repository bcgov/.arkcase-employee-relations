        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="letter">
                ...
                <fo:flow flow-name="xsl-region-body" font-family="'Lucida Grande',Tahoma,Arial,sans-serif">
                    <xsl:apply-templates select="changeConsultationState"/>
                    <fo:block text-align="center" font-weight="bold" font-size="12pt" space-after="0.15in">
                        Change Consultation Status Information
                    </fo:block>
                    <fo:block font-size="10pt" space-after="0.15in">
                        ...
                        <fo:block font-weight="bold" border-color="#badeff" border-style="solid" border-width=".4mm" height="12pt"
                                  padding="1mm">
                            <xsl:value-of select="changeConsultationState/changeDate"/>
                        </fo:block>
                    </fo:block>
                    <fo:block font-size="10pt" space-after="0.15in">
                        Consultation Number
                        <fo:block font-weight="bold" border-color="#badeff" border-style="solid" border-width=".4mm" height="12pt"
                                  padding="1mm">
                            <xsl:value-of select="changeConsultationState/consultationNumber"/>
                        </fo:block>
                    </fo:block>
                    <fo:block font-size="10pt" space-after="0.15in">
                        Status
                        <fo:block font-weight="bold" border-color="#badeff" border-style="solid" border-width=".4mm" height="12pt"
                                  padding="1mm">
                            <xsl:value-of select="changeConsultationState/status"/>
                        </fo:block>
                    </fo:block>
                    <fo:block font-size="10pt" space-after="0.15in">
                        ...
                        <fo:block font-weight="bold" border-color="#badeff" border-style="solid" border-width=".4mm" height="12pt"
                                  padding="1mm">
                            <xsl:value-of select="changeConsultationState/consultationResolution"/>
                        </fo:block>
                    </fo:block>
                    <fo:block font-size="10pt" space-after="0.15in">
                        Approver
                        <fo:block font-weight="bold" border-color="#badeff" border-style="solid" border-width=".4mm" height="12pt"
                                  padding="1mm">
                            <xsl:value-of select="changeConsultationState/participant"/>
                        </fo:block>
                    </fo:block>
                </fo:flow>
            </fo:page-sequence>
